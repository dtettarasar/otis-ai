...
This small script will generate secret to use with JSON Web Token. 
...
const generator = () => {
    ...
    const str = require('crypto').randomBytes(64).toString('hex');
    return str

}

const accessSecret = generator();
const refreshSecret = generator();
